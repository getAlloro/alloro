...
import proofReceiptRoutes from "./routes/proofReceipt";
import ownerReceiptRoutes from "./routes/ownerReceipt";
...
app.use("/api/proof-receipt", proofReceiptRoutes);
app.use("/api/owner-receipt", ownerReceiptRoutes);
