...
- For \`overview_card.text\` when the sampled rank is NOT #1, choose the band from the real \`search_position.position\`:
  ...
  - Position 4 through 20: state the exact sampled position and choose one action that moves the practice toward the top three. "[Client or location name] is currently #N in Local Search with a X Alloro Health Score. Recommended Action: [one action toward the top three]." Never tell a practice already in the top 20 to break into the top 20.
