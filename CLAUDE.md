...
Before any PR work, read docs/pr-pipeline-protocol.md and comply. Every plan file must contain an acceptance block (numbered behavioral items plus predicted signals) before code is written, and PR bodies may only claim what a passing acceptance item proved.
