...
- "Alloro Connect"
- "Alloro Reflect"
- "PatientPath" (legacy mark; monitor for adversarial filings)
- "ClearPath"
- "Business Clarity"
- "Alloro"
...
- **Alloro Connect** (Class 42): AI-powered website generation for local service businesses (formerly PatientPath; rename canon May 18, 2026)
- **Alloro Reflect** (Class 42): AI-powered business intelligence layer for local service businesses
...
Alloro Connect for software. Every client site we build
