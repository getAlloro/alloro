 ...
 *
 * FILLED during execution — the real migration lives at
 * src/database/migrations/20260703000000_add_location_cancellation_lifecycle.ts
 * (TypeScript, matching repo migration style). This scaffold mirrors it in
 * plain Knex JS for the plan-folder contract.
 *
 * Adds to `locations`:
 *   - status: 'active' | 'pending_cancellation' | 'cancelled' (NOT NULL, default 'active', CHECK)
 ...
 * Rollback drops the columns — status history is lost (flagged prod risk).
 */
