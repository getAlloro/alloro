...
--
-- change_source  NVARCHAR(20)  NULL — how the row's content was written:
--                save | publish | restore | restore-section | find-replace
-- revision_note  NVARCHAR(255) NULL — optional user-entered note captured at save time
--
-- Additive + nullable only. No backfill, no index — existing readers unaffected.

ALTER TABLE [website_builder].[pages]
  ADD [change_source] NVARCHAR(20) NULL,
      [revision_note] NVARCHAR(255) NULL;
