...
- **Stay in lane.** Presence-side only. AI drafts; a human approves before anything publishes. NEVER outbound-to-a-human (review REQUESTS, marketing/nurture emails, referral comms). (ONE stake-gated exception, disclosed in §4: the Ch5a transactional lead auto-ack, a single transactional acknowledgment, never nurture/marketing/referral, and needs Corey's explicit stake before build.)
