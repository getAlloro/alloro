...
**Purpose:** single source of truth for open cross-cutting issues surfaced by overwatch review. Not a task board; a ledger of what is open, who owns it, and where it stands.
**Update rule:** any agent or human closing, opening, or changing the state of an item updates this file in the same PR or session that changes the state.
**Full-fidelity version:** Notion, "Overwatch Register (Full)", under Alloro workspace. This file is the sanitized public mirror.
...
| 16 | Tracker / LANDING-ORDER staleness | Standing rule set: regenerate or supersede at batch close | CC |
| 17 | Canon manifest for the D1 advisor layer (playbook corpus spec) | Scoped, undrafted | Overwatch |
| 18 | Three client first-win briefs (honest reset, launch plan, opener); org specifics held off-repo per AGENTS.md | Offered, awaiting Corey go | Overwatch |
